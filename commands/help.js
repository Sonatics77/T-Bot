...
module.exports.run = async (Bot, message, args, prefix) => {
  ...
  .addField(`Games`, `${prefix}hangman, ${prefix}ttt <@user> (tic tac toe)`)
  .addField(`Announcements`, `${prefix}announce #channel <text>`)
  .addField(`Other`, `${prefix}cat, ${prefix}dadjoke, ${prefix}embed <colour (or hex code)> <text>, ${prefix}choose <option1>, <option 2>,... etc`);
